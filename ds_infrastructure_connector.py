...
class DSInfrastructureConnector:
    ...
    def get_infrastructure_ip_ports(self, param):
        ...
        if infrastructure_total > 0:
            summary = {"infrastructure_count": infrastructure_total, "infrastructure_found": True}
            ...
            summary = {"infrastructure_count": 0, "infrastructure_found": False}
            action_result.update_summary(summary)
    ...
    def get_infrastructure_ssl(self, param):
        ...
        if infrastructure_ssl_total > 0:
            summary = {"infrastructure_ssl_count": infrastructure_ssl_total, "infrastructure_ssl_found": True}
            action_result.update_summary(summary)
            ...
            summary = {"infrastructure_ssl_count": 0, "infrastructure_ssl_found": False}
            action_result.update_summary(summary)
    ...
    def get_infrastructure_vulnerabilities(self, param):
        ...
        if infrastructure_vulnerabilities_total > 0:
            ...
            summary = {"infrastructure_vulnerabilities_count": 0, "infrastructure_vulnerabilities_found": False}
            action_result.update_summary(summary)
