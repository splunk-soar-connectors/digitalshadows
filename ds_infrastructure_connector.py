...
from digital_shadows_consts import (DS_API_KEY_CFG, DS_API_SECRET_KEY_CFG, DS_GET_INFRASTRUCTURE_NOT_FOUND, DS_GET_INFRASTRUCTURE_SSL_NOT_FOUND,
                                    DS_GET_INFRASTRUCTURE_SSL_SUCCESS, DS_GET_INFRASTRUCTURE_SUCCESS,
                                    DS_GET_INFRASTRUCTURE_VULNERABILITIES_NOT_FOUND, DS_GET_INFRASTRUCTURE_VULNERABILITIES_SUCCESS)
