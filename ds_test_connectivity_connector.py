...
from digital_shadows_consts import (DS_API_KEY_CFG, DS_API_SECRET_KEY_CFG, DS_TEST_CONNECTIVITY_MESSAGE, DS_TEST_CONNECTIVITY_MESSAGE_FAIL,
...
class DSTestConnectivityConnector(object):
    ...
    def test_connectivity(self):
        ...
        try:
            ...
            return self._connector.set_status(phantom.APP_ERROR, "{0} {1}".format(DS_TEST_CONNECTIVITY_MESSAGE_FAIL, error_message))
        try:
