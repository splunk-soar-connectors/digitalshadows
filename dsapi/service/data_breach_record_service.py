...
class DataBreachRecordService(DSBaseService):
    ...
    def find_all(self, data_breach_id, view=None):
        ...
        path = f"/api/data-breach/{data_breach_id}/records"
    ...
    def data_breach_records_view(published="ALL", distinction=None, username=None, password=None, domain_names=None, review_statuses=None):
        view = {
            "filter": {
                "published": published,
